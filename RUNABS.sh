...
install() {
reset
echo -e "\e[38;5;77m • Welcome to Source FLAiN - اهلا بك في سورس سجاد •\e[0m"
echo -e "\e[38;5;77m      •{ Setting up offices - جاري رفع المكاتب } •\e[0m"
echo -e "\e[38;5;77m • Installing Source sajad - جاري تحميل سورس سجاد •\e[0m"
...
reset
echo -e "\e[38;5;77m    |This Source Was Developed By @ZEEEEE.|\e[0m"
echo -e "\e[38;5;77m    |  This Is The Source Channel @ZEEEEE .   |\e[0m"
echo -e "\e[38;5;77m    |               - SaJaD AhMeD -                 |\e[0m"
