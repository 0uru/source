...
--   This Is The Source Channel @YFFFY .   --
--                - FLAiN -                 --
--        -- https://t.me/YFFFY --         --
------------------------------------------------ 
redis = require('redis') 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, "❅︙عذرا عزيزي ↫ ["..data.first_name_.."](t.me/YFFFY)\n❅︙الصوره التي ارسلتها تم منعها من المجموعه", 1, 'md')
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Dev_Abs(msg.chat_id_,0, 1, "❅︙عذرا عزيزي ↫ ["..data.first_name_.."](t.me/YFFFY)\n❅︙الملصق الذي ارسلته تم منعه من المجموعه", 1, 'md')
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
...
❅︙نقاطي • بيع نقاطي
┉••┉••┉••┉••┉••┉••┉••┉┉••┉
❅︙[Source Channel](https://t.me/YFFFY)
]], 1, 'md')
else
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/YFFFY' end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '❅︙Channel ↬ @YFFFY', 1, 'html')    
end 
--     FLAiN Source   --
if Sudo(msg) then 
